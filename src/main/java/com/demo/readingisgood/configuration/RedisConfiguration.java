...
import com.demo.readingisgood.configuration.properties.GeneralProperties;
import com.demo.readingisgood.configuration.properties.RedisProperties;
...
public class RedisConfiguration {
    ...
    private Map<String, RedisCacheConfiguration> constructInitialCacheConfigurations() {
        ...
        final RedisCacheConfiguration favoriteCountCache = RedisCacheConfiguration.defaultCacheConfig()
                .entryTtl(Duration.ofMinutes(generalProperties.getDenemeCountsInSeconds()))
